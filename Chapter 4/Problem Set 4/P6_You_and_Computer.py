# -*- coding: utf-8 -*-
"""
Created on Mon May  3 18:05:43 2021
...
#as described below in the functions comments. As before, use HAND_SIZE constant to determine
...
def playGame(wordList):
    ...
    while True:
        ...
        if x == 'n':
            while True:
                y = input(str("Enter u to have yourself play, c to have the computer play: "))
                if y == 'u':
